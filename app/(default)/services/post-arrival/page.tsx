        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          <div className="pb-12 pt-32 md:pb-20 md:pt-40">
            ...
            <div className="mx-auto max-w-3xl pb-12 text-center">
              <h1 className="h1">Welcome to Your New Beginning</h1>
              <p className="mt-4 text-xl text-gray-600">At Newcomer Connect, we understand that your journey doesn't end when you land in Canada. Our comprehensive post-arrival services ensure you have the support needed to build a successful life in your new home. With over two decades of experience, we've designed our services to address every aspect of your settlement journey.</p>
            </div>
