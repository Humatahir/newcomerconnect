      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="text-4xl md:text-5xl font-extrabold mb-4">Your Journey, Our Expertise</h2>
          ...
          <div className="max-w-sm mx-auto grid gap-8 md:grid-cols-2 lg:grid-cols-3 lg:gap-16 items-start md:max-w-2xl lg:max-w-none" data-aos-id-blocks>
            {/* 1st item */}
            <div className="relative flex flex-col items-center p-6 bg-white rounded-lg shadow-xl" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]">
              <svg className="w-16 h-16 mb-4" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
                <rect className="fill-current text-canadian-red" width="64" height="64" rx="32" />
                <path className="stroke-current text-white" d="M30 39.313l-4.18 2.197L27 34.628l-5-4.874 6.91-1.004L32 22.49l3.09 6.26L42 29.754l-5 4.874 1.18 6.882z" strokeLinecap="square" strokeWidth="2" fill="none" fillRule="evenodd" />
              </svg>
            ...
            {/* 2nd item */}
            <div className="relative flex flex-col items-center p-6 bg-white rounded-lg shadow-xl" data-aos="fade-up" data-aos-delay="100" data-aos-anchor="[data-aos-id-blocks]">
              <svg className="w-16 h-16 mb-4" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
                <circle className="fill-current text-canadian-red" cx="32" cy="32" r="32" />
                <path className="stroke-current text-white" strokeWidth="2" strokeLinecap="square" d="M21 35l4 4 12-12" fill="none" fillRule="evenodd" />
              </svg>
            ...
            {/* 3rd item */}
            <div className="relative flex flex-col items-center p-6 bg-white rounded-lg shadow-xl" data-aos="fade-up" data-aos-delay="200" data-aos-anchor="[data-aos-id-blocks]">
              <svg className="w-16 h-16 mb-4" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
                <rect className="fill-current text-canadian-red" width="64" height="64" rx="32" />
                <g transform="translate(21 21)" strokeLinecap="square" strokeWidth="2" fill="none" fillRule="evenodd">
                  <ellipse className="stroke-current text-canadian-blue" cx="11" cy="11" rx="5.5" ry="11" />
